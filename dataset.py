...
class BCDataset(Dataset):
    def __init__(self, data_path, file_list, classes=2, cls=False, seg=True, transform=None, transform2=None, inf=False):
...
class ToTensorV2(BasicTransform):
    ...
    def __init__(self, transpose_mask=True, p=1.0):
        super(ToTensorV2, self).__init__(p=p)
